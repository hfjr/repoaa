/**
 * @actionClass goldFish/myInvestDetailOrder 
*/
define("app/vj/controller/goldFish/myInvestDetailOrder", [], function(){
	var _class_ = XDK.Class.create({
		...
		_setInitData : function(callback){
			var router = this.getApiRouter("goldFish/myInvestDetailOrder", {
				orderId : this.orderId
			});
			this.setXHR("goldFish/myInvestDetailOrder", function(){
