/**
 * @actionClass eAccount/freeze
*/
define("app/vj/controller/eAccount/freeze", [], function(){
	var _class_ = XDK.Class.create({
		...
		_getList : function(page, callback, showLoadingBar){
			...
			var router = this.getApiRouter("cunqianguan/queryTAccountFrozenDetail", {
				page : page
			});
			
			return this.setXHR("queryTAccountFrozenDetail", function(){
		...
		*/
		loadView : function(callback){
			callback  = callback || function(){};
			this.view("eAccount/freeze", function(view){
