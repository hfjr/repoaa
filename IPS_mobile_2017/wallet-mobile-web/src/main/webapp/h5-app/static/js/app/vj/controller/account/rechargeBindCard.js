...
*/
define("app/vj/controller/account/rechargeBindCard", [], function(){
	var _class_ = XDK.Class.create({
		_init_ : function(){
			_class_.baseConstructor.apply(this, arguments);
			this.title = "绑定银行卡";
			this.styleList = ["account/recharge/bindCard"];
		...
		setInitData : function(callback){
			...
			var router = this.getApiRouter("queryUserDefaultInfoForBindCard");
			this.setXHR("queryUserDefaultInfoForBindCard", function(){
		...
		init : function(){
			...
			this.view("account/recharge/bindCard", function(view){
