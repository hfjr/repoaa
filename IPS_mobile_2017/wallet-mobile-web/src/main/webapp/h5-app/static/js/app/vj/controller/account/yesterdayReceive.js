/**
 * @actionClass account/yesterdayReceive
*/
define("app/vj/controller/account/yesterdayReceive", [], function(){
	var _class_ = XDK.Class.create({
		_init_ : function(){
			...
			this.yesterdayReceive = this.getParam("yesterdayReceive") || "0.00";
			this.investList = [];
			this.isEnd = true;
			this.currentPage = 1;
		},
		...
		_getList : function(page, callback, showLoadingBar){
			...
			var router = this.getApiRouter("account/totalAccount/queryYesterdayReceive.security", {
				page : page
			});
		...
		*/
		loadView : function(callback){
			callback  = callback || function(){};
			this.view("account/yesterdayReceive", function(view){
