/**
 * @actionClass account/allAreadyReceive
*/
define("app/vj/controller/account/allAreadyReceive", [], function(){
	var _class_ = XDK.Class.create({
		...
		_getList : function(page, callback, showLoadingBar){
			...
			var router = this.getApiRouter("account/totalAccount/queryTotalAccountReceive.security", {
				page : page
			});
		...
		*/
		loadView : function(callback){
			callback  = callback || function(){};
			this.view("account/allAreadyReceive", function(view){
