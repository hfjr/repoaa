/**
 * @actionClass account/payPasswdSet
*/
define("app/vj/controller/account/payPasswdSet", [], function(){
	var _class_ = XDK.Class.create({
		_init_ : function(){
			...
			this.callbackPath = this.getParam("callbackPath") || "account/payPasswd";
		},
		...
		*/
		...
		_updatePasswd : function(passwd, callback){
			var router = this.getApiRouter("setPaymentPassword", {
				paymentPassword : passwd
			});
			callback = callback || function(){};
			console.log(router);
			this.setXHR("setPaymentPassword", function(){
