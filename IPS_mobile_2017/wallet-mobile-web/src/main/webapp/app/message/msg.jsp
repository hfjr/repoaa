...
<article class="PublicArticle" style="padding-top:30px;">
    <section style="margin:0 0 20px 20px;padding-bottom:16px;padding-left:10px;" class="BorderB3f2">
        <img class="FloatLeft" src="<c:url value='${content.iconPath}'/>" style="margin:5px 9px 0 0; width: 30px; height: 30px" >
        <div class="FloatLeft">
            <p style="font-size:1.4em;color:#4a4a4a;">  ${content.title}</p>
            <p style="font-size:1.2em;color:#9B9B9B;">  ${content.messageDate} </p>
        </div>
        <div class="cbdiv"></div>
    </section>
