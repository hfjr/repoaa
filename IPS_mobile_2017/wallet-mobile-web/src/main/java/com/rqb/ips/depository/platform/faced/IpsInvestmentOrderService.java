...
public interface IpsInvestmentOrderService {
	 ...
	 * @return
	 */
	Object placeOrderIps(String userId, String productId, String investmentAmount, String rpId, String couponId,String clientType, String token,String recommendPhone,String source);
