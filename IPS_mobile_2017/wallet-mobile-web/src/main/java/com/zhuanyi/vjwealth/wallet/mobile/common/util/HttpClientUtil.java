...
/**
 * @company 蔚捷互联网金融服务有限公司
 * @desc Httpclient 工具包装类
 * @author tony tang
 * @date 16/3/5
 */
@ComponentScan
public class HttpClientUtil {
	 ...
	 * @return 响应消息
	 */
	public static String sendGetRequest(String url, Map<String, String> params, String charset,Map<String, String> header) {
		if (url == null || StringUtils.isEmpty(url)) {
			return null;
		}
		List<NameValuePair> qparams = getParamsList(params);
		...
		try {
			...
			throw new RuntimeException("消息头添加失败", e1);
		}
		// 发送请求，得到响应
		String responseStr = null;
		try {
	...
	public static String sendPostRequest(String url, Map<String, String> params) {
		return sendPostRequest(url, params, HttpClientUtil.CHARSET_UTF8);
	}
	 ...
	 * @return 响应消息
	 */
	public static String sendPostRequest(String url, String params, String charset,Map<String,String> header) {
		if (url == null || StringUtils.isEmpty(url)) {
			return null;
		}
		// 创建HttpClient实例
	 ...
	 */
	public static String sendPostRequest(String url, Map<String, String> params, String charset, final URL keyStoreUrl,
