...
public interface IAuctionMapper {
	 ...
	 * @return
	 */
	public List<Map<String,Object>> queryProductList(@Param("page")int page,@Param("sort")String sort,@Param("productType")String productType,@Param("auction")String auction,@Param("location")String location,
			@Param("buyType")String buyType,@Param("auctionStatus")String auctionStatus);
	 ...
	 * @return
	 */
	public void doApply(AuctionApplyDTO auctionApplyDTO);
	
	public void doApplyV2(AuctionApplyDTO auctionApplyDTO);
