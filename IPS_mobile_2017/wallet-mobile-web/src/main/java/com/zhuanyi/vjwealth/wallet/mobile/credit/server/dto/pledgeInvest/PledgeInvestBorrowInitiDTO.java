 ...
 */
public class PledgeInvestBorrowInitiDTO implements Serializable{

    private String  borrowOrderLabel ;//  关联理财产品信息Label
    private PledgeInvestInitiInnerOrderInfoDTO  borrowOrder ;//  关联理财产品信息
    ...
    public PledgeInvestInitiInnerOrderInfoDTO getBorrowOrder() {
        return borrowOrder;
    }

    public void setBorrowOrder(PledgeInvestInitiInnerOrderInfoDTO borrowOrder) {
