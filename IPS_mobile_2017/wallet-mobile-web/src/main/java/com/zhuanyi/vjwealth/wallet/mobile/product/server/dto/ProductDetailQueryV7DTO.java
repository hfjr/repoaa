...
public class ProductDetailQueryV7DTO {
	...
	private String monthDiff;//与当前日期相比,相差月份
	...
	private String bidAnnouncement;//详情
	...
	public String getBidAnnouncement() {
		return bidAnnouncement;
	}
	public void setBidAnnouncement(String bidAnnouncement) {
