 ...
 */
@Service("rpBillQueryService")
public class RpBillQueryService extends AbstractBillTemplateService implements IBillTemplateService{
	...
	public List<BillListQueryDTO> getListRows(String userId, int pageIndex) {
		return billListQueryMapper.getRpBillListByUserIdAndType(userId, pageIndex);
	}
