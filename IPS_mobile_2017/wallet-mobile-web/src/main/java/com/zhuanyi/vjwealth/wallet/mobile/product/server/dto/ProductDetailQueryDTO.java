...
public class ProductDetailQueryDTO {
	...
	private String paymentNoticeLabel;
	...
	public String getPaymentNoticeLabel() {
		return paymentNoticeLabel;
	}

	public void setPaymentNoticeLabel(String paymentNoticeLabel) {
		this.paymentNoticeLabel = paymentNoticeLabel;
	}
