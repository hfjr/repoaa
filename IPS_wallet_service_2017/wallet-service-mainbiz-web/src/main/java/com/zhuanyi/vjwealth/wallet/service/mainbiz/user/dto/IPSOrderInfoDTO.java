...
public class IPSOrderInfoDTO {
	private BigDecimal rpValue;
	public BigDecimal getRpValue() {
		return rpValue;
	}

	public void setRpValue(BigDecimal rpValue) {
    ...
    private BigDecimal frozenAmount;//实际金额
...
//	public static final String ORDER_STATUS_VJ_LOAN_FAIL = "apply_vj_loan_fail";//vj自营信贷（京东）-申请贷款失败
	...
	public static IPSOrderInfoDTO getTransferEaToMaConfirmOrder(String userId, String orderNo, BigDecimal amount) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
    ...
    public static IPSOrderInfoDTO getTransferTaToMaConfirmOrder(String userId, String orderNo, BigDecimal amount) {
        IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
        orderInfoDTO.setOrderNo(orderNo);
        orderInfoDTO.setPrice(amount);
        orderInfoDTO.setUserId(userId);
	...
	public static IPSOrderInfoDTO getTransferV1ToMaConfirmOrder(String userId, String orderNo, BigDecimal amount) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	public static IPSOrderInfoDTO getWithdrawEaOrder(String userId, String orderNo, BigDecimal amount, String transStatus,String accountCardId) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	public static IPSOrderInfoDTO getWithdrawTaOrder(String userId, String orderNo, BigDecimal amount, String transStatus,String accountCardId) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	public static IPSOrderInfoDTO getWithdrawMaOrder(String userId, String orderNo, BigDecimal amount,String accountCardId) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	public static IPSOrderInfoDTO getApplyMaToV1Order(String userId, String orderNo, BigDecimal amount) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	public static IPSOrderInfoDTO getApplyMaToEaOrder(String userId, String orderNo, BigDecimal amount) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	public static IPSOrderInfoDTO getApplyMaToTaOrder(String userId, String orderNo, BigDecimal amount) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	public static IPSOrderInfoDTO getDoRechargeToMa(String userId, String orderNo, BigDecimal amount, String cardId) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	public static IPSOrderInfoDTO getDoRechargeToMaToDispose(String userId, String orderNo, BigDecimal amount, String cardId) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	public static IPSOrderInfoDTO getRechargeRpOrder(String userId, String redBillNo, BigDecimal amount, String productId, String token, String tradeId) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setRedBillNo(redBillNo);;
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
		orderInfoDTO.setTotalPrice(amount);
	...
	public static IPSOrderInfoDTO getApplyMaToRfOrder(String userId, String bidBillNo, BigDecimal amount,BigDecimal rpValue, BigDecimal frozenAmount,String couponId,String productId, String token, String tradeId) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setRpValue(rpValue);
		orderInfoDTO.setBidBillNo(bidBillNo);;
		orderInfoDTO.setFrozenAmount(frozenAmount);;
		orderInfoDTO.setUserId(userId);
		orderInfoDTO.setTotalPrice(amount);
		orderInfoDTO.setCouponId(couponId);
	...
	public static IPSOrderInfoDTO getApplyMaToRfOrder(String userId, String orderNo, BigDecimal amount, BigDecimal activityAmount, String productId, String token, String tradeId) {
        IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
	...
	public static IPSOrderInfoDTO getTransferRfToMaConfirmOrder(String userId, String orderNo, BigDecimal amount) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	public static IPSOrderInfoDTO getApplyLnOrder(String userId, String orderNo, BigDecimal amount, String productId, String token, String tradeId) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	public static IPSOrderInfoDTO getApplyLaOrder(String userId, String orderNo, BigDecimal amount, String productId, String token, String tradeId) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	public static IPSOrderInfoDTO getApplyLaToLfOrder(String userId, String orderNo, BigDecimal amount, String productId, String token, String tradeId) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	public static IPSOrderInfoDTO getTransferLfToLaConfirmOrder(String userId, String orderNo, BigDecimal amount) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	public static IPSOrderInfoDTO getXyLoanOrder(String userId, String orderNo, BigDecimal amount, String channelTradeId) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
...
//		orderInfoDTO.setProductId(productId);
	...
	public static IPSOrderInfoDTO getXyRepaymentOrder(String userId, String orderNo, BigDecimal amount, String channelTradeId) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
...
//		orderInfoDTO.setProductId(productId);
	...
	public static IPSOrderInfoDTO getPledgeLoanOrder(String userId, String orderNo, BigDecimal amount, String channelTradeId,String relOrderNo) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	public static IPSOrderInfoDTO getPledgeLoanEarlyRepay(String userId, String orderNo, BigDecimal amount, String channelTradeId) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	public static IPSOrderInfoDTO getEnjoyWithLoanEarlyAutoRepay(String userId, String orderNo, BigDecimal amount, String channelTradeId) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	public static IPSOrderInfoDTO getPledgeLoanDueRepay(String userId, String orderNo, BigDecimal amount, String channelTradeId) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	public static IPSOrderInfoDTO getMaFrozen2LnOrder(String userId, String orderNo, BigDecimal amount, String channelTradeId) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	public static IPSOrderInfoDTO getMaAutoFrozen2LnOrderForCana(String userId, String orderNo, BigDecimal amount, String channelTradeId) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	public static IPSOrderInfoDTO getSubsidy2LnOrder(String userId, String orderNo, BigDecimal amount, String channelTradeId,String relOrderNo) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	//工资先享 -- 借款中订单
	public static IPSOrderInfoDTO getWageAdvanceApplyOrder(String userId, String orderNo, BigDecimal amount, String channelTradeId,String relOrderNo) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	//工资先享 -- 提前还款（余额）
	public static IPSOrderInfoDTO getWageAdvanceEarlyRepay(String userId, String orderNo, BigDecimal amount, String channelTradeId,String relOrderNo) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	//工资先享 -- 银行卡扣款（提前还款）
	public static IPSOrderInfoDTO getWageAdvanceEarlyRepaySingleWithhold(String userId, String orderNo, BigDecimal amount,String tradeAccountCardId, String channelTradeId,String relOrderNo) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	//工资先享 -- 银行卡扣款汇总(提前还款)
	public static IPSOrderInfoDTO getEarlyBankCardWithhold(String userId, String orderNo, BigDecimal principal,BigDecimal amount,String tradeAccountCardId, String channelTradeId,String relOrderNo) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
	...
	//工资先享 -- 到期还款(余额)
	public static IPSOrderInfoDTO getWageAdvanceDueRepay(String userId, String orderNo, BigDecimal amount, String channelTradeId,String relOrderNo) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	//工资先享 -- 到期还款银行卡扣款（到期还款）
	public static IPSOrderInfoDTO getWageAdvanceDueRepaySingleWithhold(String userId, String orderNo, BigDecimal amount,String tradeAccountCardId, String channelTradeId,String relOrderNo) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	//工资先享 -- 银行卡扣款汇总(到期还款)
	public static IPSOrderInfoDTO getDueBankCardWithhold(String userId, String orderNo, BigDecimal principal,BigDecimal amount,String tradeAccountCardId, String channelTradeId,String relOrderNo) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(principal);
		orderInfoDTO.setUserId(userId);
	...
	public static IPSOrderInfoDTO getSalaryPlanMBOrderInfoWithhold(String userId, String cardId, String planCode, BigDecimal amount,String orderNo) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	//vj自营信贷 -- 借款成功订单
	public static IPSOrderInfoDTO getVjSelfSupportLoanApplyOrder(String userId, String orderNo, BigDecimal amount, String channelTradeId,String relOrderNo) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	public static IPSOrderInfoDTO getVjSelfLoanDueRepaySingleWithhold(String userId, String orderNo, BigDecimal amount,String tradeAccountCardId, String channelTradeId,String relOrderNo) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(amount);
		orderInfoDTO.setUserId(userId);
	...
	//vj自营信贷 -- 银行卡扣款汇总(到期还款)
	public static IPSOrderInfoDTO getVjSelfLoanDueBankCardWithhold(String userId, String orderNo, BigDecimal principal,BigDecimal amount,String tradeAccountCardId, String channelTradeId,String relOrderNo) {
		IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
		orderInfoDTO.setOrderNo(orderNo);
		orderInfoDTO.setPrice(principal);
		orderInfoDTO.setUserId(userId);
	...
	//picc自营信贷 -- 借款成功订单
		public static IPSOrderInfoDTO getPiccSupportLoanApplyOrder(String userId, String orderNo, BigDecimal amount, String channelTradeId,String relOrderNo) {
			IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
			orderInfoDTO.setOrderNo(orderNo);
			orderInfoDTO.setPrice(amount);
			orderInfoDTO.setUserId(userId);
		...
		public static IPSOrderInfoDTO getPiccLoanDueRepaySingleWithhold(String userId, String orderNo, BigDecimal amount,String tradeAccountCardId, String channelTradeId,String relOrderNo) {
			IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
			orderInfoDTO.setOrderNo(orderNo);
			orderInfoDTO.setPrice(amount);
			orderInfoDTO.setUserId(userId);
		...
		public static IPSOrderInfoDTO getPiccLoanDueBankCardWithhold(String userId, String orderNo, BigDecimal principal,BigDecimal amount,String tradeAccountCardId, String channelTradeId,String relOrderNo) {
			IPSOrderInfoDTO orderInfoDTO = new IPSOrderInfoDTO();
			orderInfoDTO.setOrderNo(orderNo);
			orderInfoDTO.setPrice(principal);
			orderInfoDTO.setUserId(userId);
