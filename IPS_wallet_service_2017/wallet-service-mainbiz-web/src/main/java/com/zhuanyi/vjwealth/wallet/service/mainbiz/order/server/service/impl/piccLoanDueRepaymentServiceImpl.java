 ...
 */
@Service("piccLoanDueRepaymentServiceImpl")
public class piccLoanDueRepaymentServiceImpl extends AbstractDueRepaymentService implements IDueRepaymentService {
    ...
    public TradeSearchResultDTO doCutBankcardAmount(final DueRepaymentBankCardWithholdDTO paramDto) {
        return super.invokingWithhold(paramDto,MBOrderInfoDTO.ORDER_TYPE_PICC_DUE_BANKCARD_WITHHOLD);
    }
