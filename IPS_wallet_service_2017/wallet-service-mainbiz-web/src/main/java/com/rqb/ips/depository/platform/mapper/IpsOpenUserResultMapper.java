...
public interface IpsOpenUserResultMapper {
	...
	void updateUserId(@Param("id")String id, @Param("ipsAcctNo")String ipsAcctNo,@Param("status")String status);

	Map<String, String> queryUserOpenStuats(@Param("id")String id,@Param("merBillNo") String merBillNo);

	void insertUserId(@Param("id")String id, @Param("ipsAcctNo")String ipsAcctNo,@Param("status")String status,@Param("times")String times);
